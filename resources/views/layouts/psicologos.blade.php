    ...
    <body class="bg-gray-100 dark:bg-gray-900 md:px-10 md:mt-5 text-slate-950 dark:text-slate-200">
        <nav id="nav"
            ...
            <div class="w-full overflow-y-hidden">
                ...
                <ul class="flex flex-col gap-5 mt-3">
                    <li>
                        <a href="{{ route('psicologo.control.pacientes') }}"
                            class="flex items-center text-xl gap-2  {{ request()->routeIs('psicologo.control.pacientes') ? 'bg-blue-400 dark:bg-slate-600 border-2 border-blue-600 dark:border-blue-400' : 'bg-slate-200 dark:bg-slate-700' }} rounded-md px-3 py-2 hover:bg-slate-400  dark:hover:bg-slate-600 ease-in duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li>
                        <a href="{{ route('psicologo.control.citas') }}"
                            class="flex items-center text-xl gap-2  {{ request()->routeIs('psicologo.control.citas') ? 'bg-blue-400 dark:bg-slate-600 border-2 border-blue-600 dark:border-blue-400' : 'bg-slate-200 dark:bg-slate-700' }} rounded-md px-3 py-2 hover:bg-slate-400  dark:hover:bg-slate-600 ease-in duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
